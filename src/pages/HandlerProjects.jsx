...
export default function HandlerProjects() {
    ...
    { 
      ...
      projects: [
        { 
          ...
          team: ["Sarah", "Mike"],
          tickets: [
            { id: "TKT-001", title: "New hire onboarding access", status: "Open", priority: "High", date: "2025-03-20", user: "Astghik", userAvatar: "AN", description: "Need to setup access for new developer" },
    ...
    { 
      ...
      projects: [
        { 
          ...
          team: ["Lisa", "John"],
          tickets: [
            { id: "TKT-003", title: "Expense Reimbursement", status: "Resolved", priority: "Medium", date: "2025-03-25", user: "Astghik", userAvatar: "AN", description: "Team dinner reimbursement request" },
          ]
        },
        { 
          id: 202,
      ...
      projects: [
        { 
          ...
          tickets: [
            ...
            { id: "TKT-007", title: "Monitor Upgrade", status: "Resolved", priority: "Medium", date: "2025-03-29", user: "Astghik", userAvatar: "AN", description: "Monitor replacement for John" },
          ]
        },
        { 
          id: 302,
    ...
    { 
      ...
      projects: [
        { 
          ...
          team: ["John", "Lisa"],
          tickets: [
            { id: "TKT-009", title: "Software License Request", status: "Open", priority: "High", date: "2025-03-27", user: "Astghik", userAvatar: "AN", description: "Request for Adobe Creative Cloud license" },
          ]
        },
        { 
          id: 402,
    ...
    { 
      ...
      projects: [
        { 
          ...
          team: ["Mike", "Sarah"],
          tickets: [
            { id: "TKT-012", title: "Client Complaint - Service Delay", status: "In Progress", priority: "Critical", date: "2025-03-26", user: "Astghik", userAvatar: "AN", description: "Customer complaint about service response time" },
          ]
        },
        { 
          id: 502,
          ...
          tickets: [
            ...
            { id: "TKT-014", title: "API Performance Issue", status: "Resolved", priority: "High", date: "2025-03-24", user: "Astghik", userAvatar: "AN", description: "API gateway returning 500 errors" },
          ]
        },
      ]
    },
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px", marginBottom: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 25px rgba(16,185,129,0.35)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 4px 15px rgba(16,185,129,0.25)"; }}
            >
              <ArrowLeft size={18} />
              <span>Back to Dashboard</span>
            </button>
            
            <div style={{ width: "4px", height: "30px", background: "linear-gradient(180deg, #10b981, #059669)", borderRadius: "2px" }} />
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <p style={{ color: "#64748b", marginTop: "4px", fontSize: "14px" }}>Manage all spaces, projects, and tickets • Handler: {handlerName}</p>
                </div>
              </div>
            </div>
          </div>
