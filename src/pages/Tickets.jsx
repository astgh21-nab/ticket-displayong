        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px", marginBottom: "20px" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              {/* Back Button - navigates to TicketManager2 */}
              <button
              ...
              <div>
                <h1 style={{ fontSize: "32px", fontWeight: "700", background: "linear-gradient(135deg, #fff, #94a3b8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", margin: 0 }}>TicketFlow</h1>
                <p style={{ color: "rgba(255,255,255,0.7)", marginTop: "4px", fontSize: "14px" }}>Manage, track, and create support requests</p>
              </div>
            </div>
          </div>
          <button
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: "4px", background: "rgba(0,0,0,0.3)", padding: "4px", borderRadius: "40px" }}>
            <button onClick={() => setViewMode("kanban")} style={{ padding: "8px 20px", borderRadius: "30px", border: "none", background: viewMode === "kanban" ? "linear-gradient(135deg, #3b82f6, #2563eb)" : "transparent", color: viewMode === "kanban" ? "#fff" : "rgba(255,255,255,0.7)", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px", transition: "all 0.2s" }}>
              <LayoutGrid size={16} /> Kanban
            </button>
            <button onClick={() => setViewMode("table")} style={{ padding: "8px 20px", borderRadius: "30px", border: "none", background: viewMode === "table" ? "linear-gradient(135deg, #3b82f6, #2563eb)" : "transparent", color: viewMode === "table" ? "#fff" : "rgba(255,255,255,0.7)", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px", transition: "all 0.2s" }}>
              <Table size={16} /> Table
            </button>
          </div>
        </div>
                ...
                {filteredTickets.map(ticket => (
                  <tr key={ticket.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)", transition: "background 0.2s" }} onMouseEnter={e => e.currentTarget.style.background = "rgba(255,255,255,0.05)"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                    ...
                    <td style={{ padding: "16px", textAlign: "center" }}>
                      <button onClick={() => setSelectedTicket(ticket)} style={{ padding: "6px 14px", background: "rgba(59,130,246,0.2)", border: "1px solid rgba(59,130,246,0.3)", borderRadius: "8px", cursor: "pointer", fontSize: "12px", marginRight: "6px", color: "#60a5fa" }}>View</button>
